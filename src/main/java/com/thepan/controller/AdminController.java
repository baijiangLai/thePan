...
import com.thepan.entity.vo.user.UserInfoVO;
...
public class AdminController {
    ...
    public ResponseVO getSysSettings() {
        ...
        return ResponseUtil.getSuccessResponseVO(sysSettingsDto);
    }
    ...
    public ResponseVO loadUser(UserInfoQuery userInfoQuery) {
        ...
        return ResponseUtil.getSuccessResponseVO(ResponseUtil.convert2PaginationVO(resultVO, UserInfoVO.class));
    }
    ...
    public ResponseVO getFolderInfo(@VerifyParam(required = true) String path) {
        List<FileInfo> folderInfo = fileInfoService.getFolderInfo(path, null);
        return ResponseUtil.getSuccessResponseVO(folderInfo);
    }
    ...
    public ResponseVO createDownloadUrl(@PathVariable("userId") @VerifyParam(required = true) String userId,
                                        @PathVariable("fileId") @VerifyParam(required = true) String fileId) {
        String downloadUrl = fileInfoService.createDownloadUrl(fileId, userId);
